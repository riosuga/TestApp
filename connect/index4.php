      ...
      <div class="row">
           ...
           <li class="dropdown active">
              <a class="dropdown-toggle" data-toggle="dropdown" href="#">Pendaftaran
                ...
                <ul class="dropdown-menu">
                    ...
                    <li class="active"><a href="index4.php">Pendaftaran Impor</a></li>
                </ul>
           </li>
        ...
        <div class="row" style="padding-top: 25px;padding-left: 75px;padding-right: 75px;">
                  <div class="col-sm-9 col-sm-offset-3 col-md-4 col-md-offset-2 main well">
                      <div class="row">
                        <b><div class="col-lg-12 text-center">List Pendaftaran Inhouse Impor</div></b>
                        <br/>
                        <br/>
                <!-- /.col-lg-12 -->
                   </div>
                                  ...
                                  <?php  
                                   if($_SERVER['REQUEST_METHOD']=='POST'){
                                    if(isset($_POST['ediNumber1'])){
                                       ...
                                       $hasilx = $client->cariPendaftaranImpor(array('edinumber'=>$_POST['ediNumber1']));
               ...
               <div class="col-sm-9 col-sm-offset-3 col-md-4 col-md-offset-2 main well">
                 <div class="row">
                        <b><div class="col-lg-12 text-center">Form Pendaftaran Inhouse Impor</div></b>
                        <br/>
                        <br/>
                <!-- /.col-lg-12 -->
                   </div>
                                ...
                                <div class="form-group">
                                 ...
                                 <?php if($_SERVER['REQUEST_METHOD']=='POST'){
                                     ...
                                     if(isset($_POST['ediNumber2']) && isset($_POST['nmPerushaan']) && isset($_POST['kdPiloting']) && isset($_POST['kdKantor'])){
                                      ...
                                      $url = "http://localhost:9090/skdsdksldks?wsdl";
                                      $client  = new SoapClient($url);
                                      $hasil = $client->insertPendaftaranManualImpor($params);
